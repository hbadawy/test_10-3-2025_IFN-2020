...
def train(model, train_loader, val_loader, optimizer, loss_function1,loss_function2,loss_function3,loss_function4,loss_function5, device, num_epochs, save_path, scheduler):
    ...
    for epoch in range(num_epochs):
        ...
        for _, data in enumerate(train_loader):
            optimizer.zero_grad()
            pre_tensor, post_tensor, label_tensor, label2, label3, label4, label5, fname = data["pre"], data["post"], data["label1"],data["label2"],data["label3"],data["label4"],data["label5"], data["fname"]
...
if __name__ == "__main__":
    ...
    num_epochs = 10
    save_path = "E://VS Projects//test_10-3-2025_IFN-2020//Checkpoints//checkpoint2-BCE-10epochs-"
